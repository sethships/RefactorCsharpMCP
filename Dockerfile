...
# Enable build context scanning for SBOM generation (captures .csproj, source files)
...
# Enable build stage scanning for SBOM (captures NuGet packages, SDK dependencies)
